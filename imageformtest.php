     ...
     <?php 
        ...
        if(!$establishCon) {
            ...
            exit();
                ...
                if (!$tableExist) {
                    $createTableQuery =
                        "CREATE TABLE nearMissImages (imageID INT AUTO_INCREMENT PRIMARY KEY, imageFileName VARCHAR(255) NOT NULL, imageFiles longblob NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=latin1;";
